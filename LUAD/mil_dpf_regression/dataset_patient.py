...
class Dataset(torch.utils.data.Dataset):
	def __init__(self, image_dir=None, normal_image_dir=None, dataset_dir=None, dataset_type='test', fold_list=None, patch_size=299, num_instances=200, num_bags_per_patient=100):
		...
		self._num_bags_per_patient = num_bags_per_patient
	...
	def __len__(self):
		return self._num_bags_per_patient
	...
	def __getitem__(self, idx):
		...
		temp_index = self._current_patient_ind
